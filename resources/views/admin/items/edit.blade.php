<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            ...
            {!! __('Item &raquo; Edit &raquo; #') . $item->id . ' &middot; ' . $item->name !!}
        </h2>
    </x-slot>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <select name="brand_id"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                required>
                                <option value="" disabled {{ old('type_id', $item->brand_id) ? '' : 'selected' }}>
                                    Select Brand</option>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <select name="type_id"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                required>
                                <option value="" disabled {{ old('type_id', $item->type_id) ? '' : 'selected' }}>
                                    Select Type</option>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('photos') }}" name="photos[]"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="file" accept="image/png, image/jpg, image/jpeg, image/webp"
                                multiple>
                            <div class="mt-2 text-sm text-gray-500">
